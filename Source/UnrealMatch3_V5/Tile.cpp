...
void ATile::SetTileMaterial_Implementation(UMaterialInstanceConstant* MaterialToUse)
{
	GetRenderComponent()->SetMaterial(0, Cast<UMaterialInterface>(MaterialToUse));
}
